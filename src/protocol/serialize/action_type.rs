...
pub fn action_type(action: &Action) -> &'static str {
    match action {
        ...
        Action::InputListLayouts => "input.layouts.list",
        Action::InputGetLayout => "input.layout.get",
        Action::InputSetLayout { .. } => "input.layout.set",
        Action::InputAddLayout { .. } => "input.layout.add",
        Action::InputRemoveLayout { .. } => "input.layout.remove",
        ...
        Action::PortalScreenshot { .. } => "portal.screenshot",
        Action::PortalScreencastStart { .. } => "portal.screencast_start",
        Action::PortalScreencastStop => "portal.screencast_stop",
        ...
        Action::NotificationAction { .. } => "notification.action",
        Action::NotificationClearHistory => "notification.clear_history",
        Action::NotificationWatch => "notification.watch",
        ...
        Action::SystemCpuSetGovernor { .. } => "system.cpu.set_governor",
        ...
        Action::ScheduleList => "schedule.list",
        Action::ScheduleAdd { .. } => "schedule.add",
        Action::ScheduleRemove { .. } => "schedule.remove",
        ...
        Action::NetworkConnectionList => "network.connections.list",
        Action::NetworkConnectionProfiles => "network.connections.profiles",
        Action::NetworkCreateHotspot { .. } => "network.hotspot.start",
        Action::NetworkStopHotspot => "network.hotspot.stop",
        Action::NetworkWifiEnable { .. } => "network.wifi.enable",
        Action::NetworkWwanEnable { .. } => "network.wwan.enable",
        Action::NetworkDnsSet { .. } => "network.dns.set",
        Action::NetworkDnsReset => "network.dns.reset",
        Action::NetworkVpnConnect { .. } => "network.vpn.connect",
        Action::NetworkVpnDisconnect => "network.vpn.disconnect",
        ...
        Action::AudioListSources => "audio.list_sources",
        Action::AudioGetVolume { .. } => "audio.get_volume",
        Action::AudioSetVolume { .. } => "audio.set_volume",
        Action::AudioMute { .. } => "audio.mute",
        Action::AudioSetDefault { .. } => "audio.set_default",
        ...
        Action::RuleList => "rule.list",
        Action::RuleGet { .. } => "rule.get",
